 ...
 */
    const c = a => {
        var e, {target: f, ref: g, offset: h, placement: i, prevPlacement: j, useRaf: l=!0, track: k} = a, m = {
            x: g.x,
            y: g.y,
            h: 0,
            w: 0
        ...
        g.parentNode && (e = g.ownerDocument.defaultView,
        ...
        if (d( () => {
            ...
            f.setAttribute("data-pos-overflow", Object.entries(r).reduce( (a, [b,c]) => c ? `${a} ${b}` : a, "").trim()),
            [["pos-left", r.right ? p.w - q.w : m.x], ["pos-top", m.y], // pos.y > offset[1] ? pos.y : 0
            ["pos-target-width", q.w], ["pos-target-height", q.h], ["pos-ref-width", n.width || 0], ["pos-ref-height", n.height || 0], ["pos-ref-left", n.x], ["pos-ref-top", n.y], ["window-scroll-y", window.scrollY], ["window-scroll-x", window.scrollX]].forEach( ([a,c]) => f.style.setProperty("--" + a, b(c)))
        }
        ),
