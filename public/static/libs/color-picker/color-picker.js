...
!function(t, e) {
    ...
    const i = t => t.match(/\((.*)\)/)[1].split(",").map(Number)
      ...
      , r = t => {
        ...
        return s.fillStyle = t,
        "#" == (e = s.fillStyle)[0] ? e : l(e)
    }
      , l = t => {
        const [e,s,o,a] = i(t)
    ...
    function p(t) {
        const {buttons: {undo: e, format: s}} = this.settings;
    ...
    function S(t, e) {
        const {buttons: {add: s}} = this.settings;
    ...
    function w(t) {
        ...
        e && s && (t.target.value = Math.min(Math.max(+e + i, 0), +s),
        C.call(this, t))
    }
    function f(t) {
    ...
    function y(t) {
        this.setColor(this.getHSLA(t.target.value)),
        this.DOM.value.blur()
    }
    function O(t) {
        const {name: e, parentNode: s, classList: i, title: o} = t.target;
        "format" == e ? this.swithFormat() : "undo" == e ? this.history.undo() : "addSwatch" == e ? this.addSwatch() : "removeSwatch" == e ? this.removeSwatch(s, s.title) : i.contains("color-picker__swatch") && o && (this.history.last = this.color,
        this.setColor(this.getHSLA(o)))
    }
    var $ = Object.freeze({
        __proto__: null,
        bindEvents: function() {
            ...
            this.settings.onClickOutside && (document.body.addEventListener("click", b.bind(this)),
    ...
    var k = Object.freeze({
        ...
        getSetGlobalSwatches: function(t) {
            const e = this.settings.swatchesLocalStorage
              , s = "string" == typeof e ? e : "";
            return e && t && (localStorage.setItem(D + s, t.join(";")),
            dispatchEvent(new Event("storage"))),
            localStorage[D + s]?.split(";").filter(String) || []
        },
        removeSwatch: function(t, e) {
            t.classList.add("cp_remove"),
        ...
        syncGlobalSwatchesWithLocal: function() {
            ...
            this.DOM.swatches && setTimeout(( () => {
                ...
                this.DOM.swatches.replaceWith(t),
                this.DOM.swatches = t
            }
            ), 500)
        }
    ...
    F.prototype = {
        ...
        getHSLA(t) {
            let e;
            if (t)
                return t + "" == "[object Object]" && Object.keys(t).join("").startsWith("hsl") ? t : (this.colorFormat = this.getColorFormat(t),
                t.indexOf("hsla") ? (t = r(t),
                t = h(t),
                e = c(t)) : (e = o(t),
                e = {
                    h: e[0],
        ...
        setCSSColor() {
            ...
            "rgba" == this.colorFormat ? this.CSSColor = h(this.CSSColor) : "hsla" == this.colorFormat && (this.CSSColor = a(this.color)),
