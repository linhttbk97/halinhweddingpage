    ...
    var t = {
        362: (t, e, i) => {
                    ...
                    async fn(e) {
                        const {x: i, y: s} = e
                          , a = await async function(t, e) {
                            ...
                            return d && "number" == typeof v && (m = "end" === d ? -1 * v : v),
                            u ? {
                                x: m * p,
                                y: g * f
                            } : {
                ...
                return void 0 === t && (t = {}),
                {
                    ...
                    async fn(e) {
                        const {x: i, y: o, placement: s} = e
                          , {mainAxis: a=!0, crossAxis: l=!1, limiter: c={
                            fn: t => {
                                let {x: e, y: i} = t;
                                return {
                                    x: e,
              ...
              , A = function(t) {
                return void 0 === t && (t = {}),
                {
                    ...
                    async fn(e) {
                        ...
                        let g, m;
                        "top" === p || "bottom" === p ? (g = p,
                        m = h === (await (null == s.isRTL ? void 0 : s.isRTL(a.floating)) ? "start" : "end") ? "left" : "right") : (m = p,
                        g = "end" === h ? "top" : "bottom");
                        const v = f(u.left, 0)
                          , y = f(u.right, 0)
                          , b = f(u.top, 0)
            ...
            function J(t, e, i) {
                ...
                let l = 1
                  , c = 1;
                e && z(t) && (l = t.offsetWidth > 0 && $(a.width) / t.offsetWidth || 1,
            ...
            function Z(t) {
                return (e = t,
                (e instanceof R(e).Node ? t.ownerDocument : t.document) || window.document).documentElement;
                var e
            }
            function U(t) {
                return W(t) ? {
            ...
            const lt = {
                ...
                convertOffsetParentRelativeRectToViewportRelativeRect: function(t) {
                    ...
                    if ((o || !o && "fixed" !== n) && (("body" !== H(i) || F(r)) && (s = U(i)),
                    z(i))) {
                        const t = J(i, !0);
                        a.x = t.x + i.clientLeft,
                        a.y = t.y + i.clientTop
                    }
                    return {
                        ...e,
            ...
            function ct(t, e, i, n) {
                ...
                return a && function e() {
                    const n = J(t);
                    !f || n.x === f.x && n.y === f.y && n.width === f.width && n.height === f.height || i(),
                    f = n,
            ...
            const dt = (t, e, i) => (async (t, e, i) => {
                ...
                for (let i = 0; i < r.length; i++) {
                    ...
                    w.rects && (c = !0 === w.rects ? await s.getElementRects({
                        reference: t,
                        floating: e,
                        strategy: o
                    }) : w.rects),
        ...
        319: (t, e) => {
            ...
            e.computeBackdropAttributes = function() {
                this.options && (this.backdrop.className = "tg-backdrop",
            ...
            e.computeBackdropPosition = function(t) {
                return new Promise((async (e, i) => {
                    ...
                    if (!t.backdrop)
                        return i("No backdrop element initialized");
                    ...
                    if (o === document.body) {
                        ...
                        n.fixed ? (t.backdrop.style.position = "fixed",
                        t.backdrop.style.top = r.top - t.options.targetPadding / 2 + "px",
                        t.backdrop.style.left = (s ? r.x : r.x - t.options.targetPadding / 2) + "px") : (t.backdrop.style.position = "absolute",
        ...
        693: (t, e, i) => {
            ...
            async function r(t) {
                ...
                t.options.showStepDots && "body" === t.options.stepDotsPlacement) {
                    const t = (0,
                    n.dotsWrapperHtmlString)();
                    t && (e += t)
                }
                e += '<div class="tg-dialog-footer">';
                let i = "tg-dialog-btn"
                  , o = "false";
                if (0 === t.activeStep && (o = "true",
                i += " disabled"),
                ...
                return t.options.showStepProgress && (e += '<span class="tg-step-progress" id="tg-step-progress">\x3c!-- JS rendered --\x3e</span>'),
                e += "</div>",
            ...
            e.createTourGuideDialog = async function() {
                return this.dialog = document.createElement("div"),
            ...
            e.updateDialogHtml = function(t) {
                return new Promise(( (e, i) => {
                    ...
                    s && o && ("string" == typeof o.content ? s.innerHTML = o.content ? o.content : "" : (s.innerHTML = "",
                    s.append(o.content)));
                    const a = document.getElementById("tg-dialog-dots");
                    a && t.options.showStepDots && (0,
                    n.computeDots)(t) && (a.innerHTML = (0,
                    n.computeDots)(t));
                    const l = document.getElementById("tg-dialog-prev-btn");
                    l && (0 === t.activeStep ? (l.classList.add("disabled"),
                    l.setAttribute("disabled", "true")) : (l.classList.remove("disabled"),
                    ...
                    u && (t.options.progressBar && (u.style.backgroundColor = t.options.progressBar),
                    u.style.width = (t.activeStep + 1) / t.tourSteps.length * 100 + "%"),
                    e(!0)
                }
                ))
            }
            ...
            e.computeDialogPosition = function(t) {
                return new Promise((async e => {
                    ...
                    if (n === document.body)
                        return Object.assign(t.dialog.style, {
        ...
        500: (t, e) => {
            ...
            e.dotsWrapperHtmlString = function() {
                ...
                return t.classList.add("tg-dialog-dots"),
                t.id = "tg-dialog-dots",
                t.outerHTML
            }
            ,
        ...
        737: (t, e) => {
            ...
            e.clickOutsideHandler = async function(t) {
                ...
                if (t.clientX >= e.x && t.clientX <= e.x + e.width && t.clientY >= e.y && t.clientY <= e.y + e.height)
                    return;
            ...
            e.keyPressHandler = async function(t) {
                return "Escape" === t.key && this.options.exitOnEscape ? (t.preventDefault(),
                void await this.exit()) : "ArrowRight" === t.key && this.options.keyboardControls ? (t.preventDefault(),
                void this.visitStep("next").catch((t => {
                    this.options.debug && console.warn(t)
                }
                ))) : "ArrowLeft" === t.key && this.options.keyboardControls ? (t.preventDefault(),
            ...
            e.handleInitListeners = function() {
                const t = () => {
                    ...
                    t && !this._trackedEvents.nextBtnClickEvent.initialized && (t.addEventListener("click", this._trackedEvents.nextBtnClickEvent.fn),
                    this._trackedEvents.nextBtnClickEvent.initialized = !0)
                }
                  , e = () => {
                    let t = document.getElementById("tg-dialog-prev-btn");
                    t && !this._trackedEvents.prevBtnClickEvent.initialized && (t.addEventListener("click", this._trackedEvents.prevBtnClickEvent.fn),
                    this._trackedEvents.prevBtnClickEvent.initialized = !0)
                }
                  , i = () => {
                    let t = document.getElementById("tg-dialog-close-btn");
                    t && !this._trackedEvents.closeBtnClickEvent.initialized && (t.addEventListener("click", this._trackedEvents.closeBtnClickEvent.fn, !1),
                    this._trackedEvents.closeBtnClickEvent.initialized = !0)
                }
                  , n = () => {
                    this._trackedEvents.outsideClickEvent.initialized || (document.body.addEventListener("click", this._trackedEvents.outsideClickEvent.fn, !1),
                    this._trackedEvents.outsideClickEvent.initialized = !0)
                }
                  , o = () => {
                    this._trackedEvents.keyPressEvent.initialized || (window.addEventListener("keydown", this._trackedEvents.keyPressEvent.fn, !1),
                    this._trackedEvents.keyPressEvent.initialized = !0)
                }
                ;
                return new Promise((r => (this.options.showButtons && t(),
            ...
            e.handleDestroyListeners = function() {
                const t = () => {
                    let t = document.getElementById("tg-dialog-next-btn");
                    t && (t.removeEventListener("click", this._trackedEvents.nextBtnClickEvent.fn),
                    this._trackedEvents.nextBtnClickEvent.initialized = !1)
                }
                  , e = () => {
                    let t = document.getElementById("tg-dialog-prev-btn");
                    t && (t.removeEventListener("click", this._trackedEvents.prevBtnClickEvent.fn),
                    this._trackedEvents.prevBtnClickEvent.initialized = !1)
                }
                  , i = () => {
                    let t = document.getElementById("tg-dialog-close-btn");
                    t && (t.removeEventListener("click", this._trackedEvents.closeBtnClickEvent.fn, !1),
                    this._trackedEvents.closeBtnClickEvent.initialized = !1)
                }
                  , n = () => {
                    document.body.removeEventListener("click", this._trackedEvents.outsideClickEvent.fn, !1),
                    this._trackedEvents.outsideClickEvent.initialized = !1
                }
                  , o = () => {
                    window.removeEventListener("keydown", this._trackedEvents.keyPressEvent.fn, !1),
        ...
        121: (t, e, i) => {
            ...
            e.default = function() {
                return new Promise((async t => {
                    ...
                    await (0,
                    n.computeBackdropPosition)(this),
                    this.dialog.style.display = "block",
                    this.options.dialogAnimate && this.isVisible && this.dialog.classList.add("animate-position"),
                    await (0,
                    o.computeDialogPosition)(this),
                    this.options.dialogAnimate && setTimeout(( () => {
        ...
        755: (t, e) => {
            ...
            e.default = async function(t) {
                return new Promise((async (e, i) => {
                    let n = [];
                    t.options.steps && t.options.steps.length && (n = t.options.steps.map((t => ("string" == typeof t.target && (t.target = document.querySelector(t.target)),
                    ...
                    return o && o.forEach((e => {
                        ...
                        t.options.targetPadding && t.options.autoScrollOffset ? e.style.scrollMargin = (l ? l + t.options.targetPadding : t.options.autoScrollOffset + t.options.targetPadding) + "px 0" : e.style.scrollMargin = (l || "30") + "px 0",
                        n.push({
                            title: i || void 0,
        ...
        971: function(t, e, i) {
            ...
            const o = n(i(755))
              ...
              , s = n(i(570));
            e.default = async function(t) {
                this.options.steps && (this.options.steps.push(...t),
                await (0,
                o.default)(this),
                this.isVisible && await (0,
                r.updateDialogHtml)(this).catch((t => {
                    this.options.debug && console.warn(t)
                }
                )),
                ...
                this.isVisible && await (0,
                s.default)(".tg-dialog").then((async () => (await this.destroyListeners(),
        ...
        283: (t, e) => {
            ...
            e.default = async function(t=!0, e="tour") {
                ...
                if (this.options.completeOnFinish) {
                    ...
                    t.push(e),
                    localStorage.tg_tours_complete = t
                }
                return t && await this.exit(),
                this.activeStep = 0,
                !0
            }
        }
        ...
        612: function(t, e, i) {
            ...
            e.handleRefreshDialog = async function() {
                return new Promise((async (t, e) => (await (0,
                r.renderDialogHtml)(this).then((t => {
        ...
        340: function(t, e, i) {
            ...
            e.default = async function(t) {
                if (t)
                    ...
                    this.computeBackdropAttributes(),
                    await (0,
                    o.renderDialogHtml)(this).then((t => {
                        t && (this.dialog.innerHTML = t)
                    }
                    )).catch((t => {
                        this.options.debug && console.warn(t)
                    ...
                    await (0,
                    o.updateDialogHtml)(this).catch((t => {
                        this.options.debug && console.warn(t)
                    }
                    )),
                    this.isVisible && await (0,
                    r.default)(".tg-dialog").then((async () => (await this.destroyListeners(),
                    await this.initListeners(),
                    !0))),
                    this
            }
        ...
        330: function(t, e, i) {
            ...
            e.default = async function(t) {
                return new Promise((async (e, i) => {
                    if (this.isVisible)
                        return this.options.debug && console.warn("Tour already active"),
                    ...
                    try {
                        ...
                        return this.options.debug && console.warn(t),
                        i(t)
                    }
                    return await n.visitStep(this.activeStep).catch((t => (this.options.debug && console.warn(t),
                    i(t)))),
                    await (0,
                    o.default)(".tg-dialog").then((async () => {
                        await this.initListeners(),
                        this.options.dialogAnimate && this.dialog.classList.add("animate-position")
                    }
                    )),
                    e(!0)
                }
        ...
        483: function(t, e, i) {
            ...
            function s(t, e) {
                return new Promise((async (i, n) => {
                    if (e >= t.tourSteps.length)
                        return n("End of tour steps");
                    if (e < 0)
                        return n("Start of tour steps");
                    const s = t.activeStep
                      , a = t.tourSteps[s]
                      , l = t.tourSteps[e];
                    if (!l || !a)
                        return n("Step not found by index");
                    ...
                    return "string" == typeof l.target && (t.tourSteps[e].target = document.querySelector(l.target)),
                    l.target && t.tourSteps[e].target || (t.tourSteps[e].target = document.body),
                    t.activeStep = Number(e),
                    await (0,
                    o.updateDialogHtml)(t).catch((e => {
                        t.options.debug && console.warn(e),
                        n(e)
                    }
                    )),
                    t.options.autoScroll && l.target !== document.body && await (0,
                    r.default)(t, l.target),
            ...
            e.default = async function(t) {
                return new Promise((async (e, i) => {
                    if ("string" == typeof t && (t = "next" === t ? this.activeStep + 1 : this.activeStep - 1),
                    !(t >= this.tourSteps.length))
                        return await s(this, t).catch((t => i(t))),
                        e(!0);
